...
// Updated script - 2018-05-09
	...
	if(isset($_POST['purchaseDetailsPurchaseID'])){
		...
		if(isset($purchaseDetailsItemNumber) && isset($purchaseDetailsPurchaseDate) && isset($purchaseDetailsQuantity) && isset($purchaseDetailsUnitPrice)){
			...
			// Validate unit price. It has to be greater than zero
			if($purchaseDetailsUnitPrice == 0 ){ 
				echo '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Please enter a unit price. It has to be greater than zero</div>';
				exit();
			}
			...
			if($purchaseDetailsItemNumber == '' || $purchaseDetailsItemNumber == 0){ 
			...
			if($purchaseDetailsQuantity == '' || $purchaseDetailsQuantity == 0){ 
