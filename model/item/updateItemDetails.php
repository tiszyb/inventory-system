<?php
	...
	if(isset($_POST['itemNumber'])) {
		...
		if(!empty($itemNumber) && !empty($itemName) && isset($itemDetailsQuantity) && isset($itemDetailsUnitPrice)){
			...
			// Validate item Unit price. It has to be greater than 0
			if($itemDetailsUnitPrice == 0){
				$errorAlert = '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button>Please enter a valid price </div>';
