							...
							<form>
							  ...
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  ...
								  <input type="text" class="form-control" name="itemDetailsItemNumber" id="itemDetailsItemNumber" value="<?php echo $pid; ?>" autocomplete="off">
								...
								<div class="form-group col-md-6" style="display:inline-block">
								  ...
								  <label for="itemDetailsDescription">Expiry Date</label>
								  <input type="text" class="form-control datepicker" id="itemDetailsDescription" name="itemDetailsDescription" value="">						
					...
					<form>
						<div class="form-row"> 
						  <div class="form-group col-md-4">
							...
							<input onkeyup="PopulatePurchaseDetails(); " type="text" class="form-control invTooltip" id="purchaseDetailsItemName" name="purchaseDetailsItemName" title="">
							 <div id="purchaseDetailsPurchaseItemNameSuggestionsDiv" class="customListDivWidth"></div>
						  </div>
						  <div class="form-group col-md-2">
					...
					<form>
						<div class="form-row">
						  <div class="form-group col-md-5">
							...
							<!--<select id="saleDetailsItemNames" name="saleDetailsItemNames" class="form-control chosenSelect"> -->
								...
								?>
							<!-- </select> -->
							<input onkeyup="PopulateSaleDetails();" type="text" class="form-control invTooltip" id="saleDetailsItemName" name="saleDetailsItemName" title="">
					  ...
					  <div class="form-row">
						<div class="form-group col-md-3">
						  ...
						  <div onMouseDown="popID();" id="saleDetailsItemNumberSuggestionsDiv" class="customListDivWidth"></div>
						</div>
						<div class="form-group col-md-3">
